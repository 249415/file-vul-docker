...
const FileUpload = () => {
  ...
  return (
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <div className='container' style={{height: "50vh", marginTop: "200px"}}>
      <h1>To start, let's upload a picture of your face so all of your friends would know that you joined the safest social network in existance</h1>
